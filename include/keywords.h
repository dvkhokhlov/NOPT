...
extern vector<const char *>dmrg_group_start      ;
extern vector<const char *>dmrg_group_end        ;
extern vector<const char *>dmrg_m_kw             ;
extern vector<const char *>dmrg_sweeps_kw        ;
extern vector<const char *>dmrg_sweep_tol_kw     ;
extern vector<const char *>dmrg_hf_occ_kw        ;
extern vector<const char *>dmrg_hf_occ_integral_kw ;
extern vector<const char *>dmrg_schedule_kw      ;
...
extern vector<const char *>dmrg_localize_boys_kw  ;
extern vector<const char *>dmrg_dump_loc_kw        ;
extern vector<const char *>dmrg_loc_order_kw         ;
extern vector<const char *>dmrg_loc_order_fiedler_kw ;
extern vector<const char *>dmrg_loc_order_gaopt_kw   ;
extern vector<const char *>dmrg_loc_order_none_kw    ;
